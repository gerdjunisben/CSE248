...
public class Demo {
	public static void main(String[] args) {
		...
		try {
			...
			URL url = new URL(
					"https://api.data.gov/ed/collegescorecard/v1/schools.json?school.degrees_awarded.predominant=2,3,4&_fields=id,school.name&_zip=11784&_distance=10mi&api_key=I1fvJ8xYBCFkAwcWuVBkgT9Bzjj6UFqrMmZ1foDP");
